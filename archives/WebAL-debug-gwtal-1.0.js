...
//            } else if ((typeof Audio !== "undefined") && (audioElement instanceof Audio)) {
            } else if(audioElement instanceof HTMLAudioElement) {
...
//        if (audioElement instanceof Array) {
        if(Array.isArray(audioElement)) {
        ...
        } else if (audioElement instanceof Audio || audioElement instanceof HTMLAudioElement) {
            // Browser <audio> element
            audio = audioElement;
            audioRef = [];
            ...
            if (sources && sources.length) {
                ...
                audioRef.push({
                    type: audio.type,//source.type,
                    src: audio.src//source.src
                });
            }
        }
